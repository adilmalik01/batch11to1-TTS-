...
<div class="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
    <a href="#">
        <img class="rounded-t-base w-full h-full"  src=${product.image} alt="" />
    </a>
    <div class="p-6 text-center">
        ...
        <a href="#">
            <h5 class="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading">${product.title}</h5>
        </a>
